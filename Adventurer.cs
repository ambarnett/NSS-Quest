...
namespace Quest
{
    ...
    public class Adventurer
    {
        ...
        public string GetDescription()
        {
            ...
            return $"The Adventurers Name is {Name} and their {colors} robe is {ColorfulRobe.Length} inches long and their hat is {AdventurersHat.ShininessDescription}";
        }
